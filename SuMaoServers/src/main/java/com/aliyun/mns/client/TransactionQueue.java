...
public class TransactionQueue {
            ...
            while(!isCheckerStop)
            {
                try{
                    ...
                    if (opLogMessage != null)
                    {
                        ...
                        if(isTransSuccess)
                        {   // transaction success, commit the message.
     ...
     *  visible to consumer.
     */
    public TransactionQueue(CloudQueue rawQueue, CloudQueue opLogQueue, TransactionChecker checker, long lifeTimeInSeconds,
